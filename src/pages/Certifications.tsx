  ...
  return (
    <div className="container mx-auto px-6 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <a href="https://catalog-education.oracle.com/ords/certview/sharebadge?id=91CFF6A5C7172C32A8456E90DDDDB7D537E2CBE42C3BC2C4AE2E260EE696D29B"
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-2xl font-semibold">Oracle Cloud Infrastructure 2025 Multicloud Architect Professional</h3>
          </div>
          <p className={`${isDarkMode ? 'text-gray-300' : 'text-gray-600'} mb-4`}>Certification ID: 323352265OCI2025MCAOCP</p>
